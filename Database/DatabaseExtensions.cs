...
namespace PmfBackend.Database {
    ...
    public static class DatabaseExtensions{
        public static IOrderedQueryable<TSource> OrderBy<TSource, TKey>(this IQueryable<TSource> source, string properyName, Expression<Func<TSource,TKey>> defaultOrderingProperty){
            ...
            var parametar = Expression.Parameter(typeof(TSource),"x");
            Expression property = Expression.Property(parametar,properyName);
            var lambda = Expression.Lambda(property,parametar);
